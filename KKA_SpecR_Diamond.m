...
rfs=dlmread('Diamond_specR.dat');%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%read data from tranmission spectrum saves as ASCII .dat file
d=size(rfs,1);
l0=rfs(1,1)-1;
...
figure; yyaxis left; plot(l,thetafin,'b');ylabel('Phase (radian)');yyaxis right;plot(l,R,'r'); ylabel('Specular Reflectance'); axis square; grid on; xlabel('wavelength');legend('Diamond (SCD)');
figure; plot(l,n,'b');axis square; legend('DSKK estimate for Diamond (SCD)');grid on; xlabel('wavelength'); ylabel('Refractive Index');
